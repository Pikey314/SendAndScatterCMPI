...
int main(int argc, char *argv[]) {
    ...
    MPI_Scatter(tablica, 3, MPI_DOUBLE,
                tablica_wejsica, 3, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    ...
    MPI_Gather(&wynik, 1, MPI_DOUBLE,
               tablica_wyjsciowa, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
